...
public class ArticleController {
	...
	ArticleController() { //생성자 초기세팅용
		...
		Article article1 = new Article(1, "안녕 지구인들아", "안녕 반가워 내 이름은 민달팽이야", "김민달팽이", "20200817");
		Article article2 = new Article(2, "JAVA 프로그래밍", "JAVA 프로그래밍 자바 프로그래밍 자바 프로그래밍 자바 프", "익명", "20200817");
		Article article3 = new Article(3, "어렵지 않아요", "어렵지 않아요 어렵지 않아요 어렵지 않아요 어렵지 않아요 어렵지 않아", "익명", "20200817");
	...
	void printReply(int targetIndex) {
		...
		for(int i = 0;i < replies.size(); i++) {
			if(replies.get(i).getId() == targetIndex) {
				System.out.println( "댓글" + (i + 1) + " : " + replies.get(i).getReply());
			}
		}
		System.out.println("=====================");
	}
